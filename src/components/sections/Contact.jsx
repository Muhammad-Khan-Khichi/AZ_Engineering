...
const ContactPage = () => {
  ...
  // Prepare service options for CustomSelect
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formBody.append('subject', `New Contact from ${formData.name} — ${formData.service || 'General Inquiry'}`)
      formBody.append('from_name', 'A & Z Engineering Website')
